<div class="form-group">
    ...
    <input type="text" name="title"  class="form-control txt_name"
           ...
           value="{{ !old('title') ? $update->title ? $update->title : "" : old('title')}}">
...
<div class="form-group">
    ...
    <textarea class="form-control " id="test2" name="preview" >
        ...
        {{ !old('preview') ? $update->preview ? $update->preview : "" : old('preview')}}
    </textarea>
...
<div class="form-group">
    ...
    <textarea class="form-control " id="test" name="text">
        {{ !old('text') ?  $update->content->text ? $update->content->text : "" : old('text')}}
